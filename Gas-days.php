...
<title>Gas Use kWh per day</title>
<?php
...
<!-- amline script-->
  <script type="text/javascript" src="/amcharts/amline/swfobject.js"></script>
	...
	<script type="text/javascript">
		...
		so.addVariable("settings_file", encodeURIComponent("Gas-days.xml?rand=<?php echo mktime();?>"));                // you can set two or more different settings files here (separated by commas)
		so.addVariable("data_file", encodeURIComponent("Gas-days-data.php?date1=<?php echo $date1 ?>&days=<?php echo $days ?>&date2=<?php echo $date2 ?>"));
